...
export default class NFTBought extends React.Component {
    ...
    getNFTBought = async () => {
        ...
        try {
            await NFT.methods.getNFTBought(accounts[0]).call({
                from: accounts[0],
                gas: '3000000',
            }).then(
                rst => {
    ...
    render() {
        return (
            <div>
                <Button type="primary" onClick={this.getNFTBought}>查询</Button>
                <br /><br />
